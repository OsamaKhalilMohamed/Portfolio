...
export default function Card({
  ...
  return (
    <div className="mx-auto flex h-full w-full max-w-[600px] flex-grow flex-col items-center rounded-xl bg-cyan-950 p-4 shadow-md hover:bg-cyan-900 dark:bg-zinc-900/90 dark:hover:bg-zinc-800">
      <div>
        <motion.div
