    ...
    <>
      ...
      <div className="mx-auto flex min-h-screen w-full max-w-[100%] justify-center py-10 dark:bg-[#111110]">
        <div className="w-5/6 max-w-[800px]">
          ...
          <article
            className="prose prose-neutral mt-6 max-w-none leading-7 md:prose-lg lg:prose-xl prose-a:border-b prose-a:border-dotted prose-a:no-underline prose-img:w-full prose-img:rounded-lg
