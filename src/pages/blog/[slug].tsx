    ...
    <>
      ...
      <div className="mx-auto flex min-h-screen w-full max-w-[100%] justify-center py-10 dark:bg-[#111110]">
        <div className="w-5/6 max-w-[800px]">
          ...
          <article
            className="prose prose-neutral mt-6 max-w-none md:prose-lg lg:prose-xl prose-a:border-b prose-a:border-dotted prose-a:no-underline prose-img:w-full
 prose-img:rounded-xl dark:prose-h2:text-gray-300 dark:prose-h3:text-gray-400 dark:prose-p:text-gray-400 dark:prose-a:text-gray-300"
