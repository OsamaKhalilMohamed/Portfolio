  ...
  return (
    <>
      ...
      <main className="flex h-full min-h-screen w-full max-w-[100%] flex-col items-center justify-start overflow-hidden scroll-smooth pb-8">
        ...
        >
          <motion.div className="flex h-full w-full flex-col items-start  bg-gradient-to-r bg-clip-text text-center text-2xl text-cyan-800 text-transparent dark:text-cyan-100 md:h-[75vh]">
              ...
              >
                ...
                <span className="flex items-center  text-xl font-semibold text-neutral-950 dark:text-yellow-50 md:text-2xl">
                  ...
                  <Link
                    ...
                    target="_blank"
                    className=" ml-2 flex h-12 items-center  rounded-xl bg-stone-100 shadow-md  dark:bg-white md:ml-4"
                  >
